...
>
> ⚠️ **Superada por [`pulselab_review_05072026.md`](./pulselab_review_05072026.md) (05-jul-2026).** La mayoría de los hallazgos P0/P1 de este documento (`requirements.txt`, rutas Windows, DRC gate, footprints SMD, autorouter) ya están resueltos — ver la tabla de correcciones en la revisión de julio antes de usar este documento como referencia de estado actual. Se conserva sin modificar como registro histórico.
