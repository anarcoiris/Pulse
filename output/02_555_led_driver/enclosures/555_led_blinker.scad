// PulseLab Forge Enclosure for: 555 LED Blinker
...
module bottom_shell() {
    ...
    translate([3.000, 3.000, base_z]) boss();
    translate([37.000, 3.000, base_z]) boss();
    translate([3.000, 22.000, base_z]) boss();
    translate([37.000, 22.000, base_z]) boss();
}
