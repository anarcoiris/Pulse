...
# ── Re-export modelos puros desde core (source of truth) ──────────────────────
# Todos los módulos que hacen `from ui.editor import CircuitGraph` siguen
# funcionando, pero la definición canónica ahora vive en core/circuit_graph.py.
from core.circuit_graph import (                       # noqa: F401
    PlacedComponent,
    Wire,
    CircuitGraph,
    SimulationRunner,
